        ...
        <View style={styles.findActivityContainer}>
          <TouchableOpacity onPress={() => getActivity()} activeOpacity={0.95} style={styles.startContainer}>
            ...
            <View style={{flex: 1, marginRight: 3}}>
              <Text style={Platform.OS === 'ios' ? {fontSize: 20, fontWeight: 'bold', color: '#696969', fontFamily: 'AvenirNext-Bold', textAlign: 'center'} : {fontSize: 20, fontWeight: 'bold', color: '#696969', textAlign: 'center'}}>Find Activity</Text>
            </View>
            <View style={{width: 40}} />
          </TouchableOpacity>
        </View>
